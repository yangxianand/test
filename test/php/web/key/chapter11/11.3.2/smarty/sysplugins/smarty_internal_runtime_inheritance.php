...
class Smarty_Internal_Runtime_Inheritance
{
     ...
     *
     * @param \Smarty_Internal_Template $tpl        templates object of caller
     ...
     * @param null|string               $uid      uid of inline templates
     * @param null|string               $func     function call name of inline templates
     *
     * @throws \Exception
    ...
    public function callParent(Smarty_Internal_Template $tpl, Smarty_Internal_Block $block, $tag)
    {
        if (isset($block->parent)) {
            ...
            throw new SmartyException("inheritance: illegal '{$tag}' used in child templates '{$tpl->inheritance->sources[$block->tplIndex]->filepath}' block '{$block->name}'");
        }
    }
